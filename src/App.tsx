...
import { Github, Linkedin, Mail, ExternalLink, ArrowRight, Sparkles, Terminal, Cpu, Box, Layout, ChevronDown, Activity, Globe } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-bg/80 backdrop-blur-xl border-b border-white/5 py-4' : 'bg-transparent py-6'}`}>
    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="max-w-5xl mx-auto px-6 text-center z-10">
        ...
        >
          ...
          Into <span className="text-gradient">Interface.</span>
        </motion.h1>
        ...
        >
          I build decision-intelligence systems and micro-SaaS tools. 
          Specializing in <strong>Gemini AI</strong>, <strong>React</strong>, and <strong>Serverless Architecture</strong>.
        </motion.p>
        ...
        >
          ...
          <a href="https://insightmesh-gamma.vercel.app/" target="_blank" className="px-8 py-4 glass-panel text-white font-medium rounded-full hover:bg-white/10 transition-all flex items-center justify-center gap-2">
...
const About = () => (
  <section id="about" className="py-32 relative">
    <div className="max-w-4xl mx-auto px-6">
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">The Architect's Mindset</h2>
        <p className="text-lg text-slate-400 leading-relaxed">
          I don't just write code; I remove friction. My approach is simple: identify the bottleneck, understand the pattern, and build a system that solves it. 
          Currently obsessed with <span className="text-white">LLM orchestration</span> and <span className="text-white">high-performance UIs</span>.
        </p>
      </motion.div>
      ...
      >
        {[
          { icon: Terminal, title: "Rapid Execution", desc: "Ship fast, iterate faster. Perfection is the enemy of done." },
          { icon: Activity, title: "Data Driven", desc: "Intuition is good. Data is better. Let metrics guide the build." },
          { icon: Box, title: "Systems Thinking", desc: "Don't fix the symptom. Re-engineer the system." },
        ].map((item, i) => (
          <motion.div key={i} variants={fadeInUp} className="glass-panel p-6 rounded-2xl">
          ...
          <div className="p-8 md:p-16 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex gap-4">
                <a href="https://insightmesh-gamma.vercel.app/" target="_blank" className="px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-lg transition-colors flex items-center gap-2">
...
{/* Cinematic Mockup - REAL SCREENSHOT */}
        ...
        </div> {/* <--- THIS CLOSES THE GRID. CRITICAL! */}
...
const Skills = () => {
  const skills = [
    ...
    { category: "Backend", items: ["Node.js", "Vercel Edge", "REST APIs", "PostgreSQL"] },
    { category: "AI Engineering", items: ["Gemini API", "Prompt Engineering", "RAG", "Web Scraping"] },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-slate-400 mb-8">
              I select tools based on <span className="text-white">speed</span>, <span className="text-white">scalability</span>, and <span className="text-white">developer experience</span>.
            </p>
          ...
          <div className="relative">
             ...
             <div className="relative glass-panel p-8 rounded-3xl border border-white/10">
                ...
                <div className="font-mono text-sm text-slate-400 space-y-2">
                  ...
                  <p className="pl-4"><span className="text-slate-500">// Ready for next challenge</span></p>
                  <p>{'}'}</p>
                </div>
             </div>
          </div>
