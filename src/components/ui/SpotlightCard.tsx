...
export function SpotlightCard({
    ...
    return (
        <div
            ...
            className={`relative rounded-xl border border-emerald-500/20 bg-[#050505]/80 overflow-hidden ${noFloat ? '' : 'animate-float'} ${className}`}
            style={{
                animationDelay: noFloat ? '0s' : animationDelay
            }}
            {...props}
        >
            <div
