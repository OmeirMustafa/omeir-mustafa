        ...
        <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-6 pointer-events-none">
            <div
                className={cn(
                    ...
                    isScrolled
                        ? "bg-black/90 backdrop-blur-md border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.12)]"
                ...
                <AnimatePresence>
                    {isMobileOpen && (
                        <motion.div
                            ...
                            className="absolute top-full left-0 right-0 mt-4 bg-black/95 border border-emerald-500/20 rounded-2xl p-6 flex flex-col gap-4 items-center shadow-2xl md:hidden overflow-hidden backdrop-blur-xl"
                        >
