...
export function HUDNavigation() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-6 pointer-events-none">
            <div className="bg-[var(--bg-deep)]/90 backdrop-blur-xl border border-[var(--hairline)] rounded-full px-4 md:px-8 py-2 flex items-center gap-8 pointer-events-auto transition-all hover:border-[var(--accent-green)]/50 shadow-[0_0_20px_var(--halo)]">
