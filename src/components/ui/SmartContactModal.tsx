            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md bg-[#0b0c10]/95 border border-cyan-400 shadow-[0_0_30px_rgba(0,255,255,0.2)] p-8 overflow-hidden rounded-lg group"
                    >
                        {/* Scanline Overlay */}
                        ...
                        <div className="space-y-4 relative z-10">
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <div className="text-sm font-bold text-slate-200">INITIALIZE GMAIL PROTOCOL</div>
                            ...
                            >
                                ...
                                <div className="text-left">
                                    <div className="text-sm font-bold text-slate-200">LAUNCH SYSTEM DEFAULT</div>
