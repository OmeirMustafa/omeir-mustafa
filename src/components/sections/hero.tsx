        ...
        >
            ...
            >
                ...
                <div className="relative text-center flex flex-col items-center gap-6 md:gap-8 py-12 md:py-24">
                    ...
                    {/* H1 Title */}
                    {/* H1 Title */}
                    <motion.h1 variants={VARIANTS.item} className="text-3xl sm:text-4xl md:text-6xl font-bold tracking-tight leading-[1.1] text-[var(--text-primary)] uppercase max-w-5xl">
                        DIGITAL PRODUCT & <br />
